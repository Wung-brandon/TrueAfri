        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <ul className="space-y-2">
              <Link href="mailto:ransomlek@yahoo.com" className="text-gray-400 hover:underline">ransomlek@yahoo.com</Link>
                <li className="text-gray-400">+46 739 397 478</li>
                <li className="text-gray-400">+45 9146 1372</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6">
              <li>
                <Link href=" https://www.facebook.com/profile.php?id=61574483563524" className="text-gray-400 hover:text-white">
              ...
              <li>
                <Link href=" https://x.com/RLTrueAfrica" className="text-gray-400 hover:text-white">
              ...
              <li>
                <Link href=" https://www.instagram.com/rltrueafrica/" className="text-gray-400 hover:text-white">
